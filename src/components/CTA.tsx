    ...
    <section className="py-16 md:py-24 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <Card className="bg-gradient-hero border-0 shadow-elegant relative overflow-hidden">
          ...
          <CardContent className="relative z-10 p-7 sm:p-8 md:p-16 pb-10 sm:pb-8 md:pb-16 text-center">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl sm:text-3xl md:text-5xl lg:text-6xl font-heading font-bold text-primary-foreground mb-5 md:mb-6 leading-tight">
                Ready to Build Your Next Project?
              </h2>
              
              <p className="text-base sm:text-base md:text-xl text-primary-foreground/90 mb-7 md:mb-12 max-w-2xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-4 md:gap-6 mb-6 md:mb-12">
                <div className="bg-background/10 backdrop-blur-sm rounded-lg p-5 sm:p-5 md:p-6 border border-primary-foreground/20">
                  <Users className="w-8 h-8 sm:w-7 sm:h-7 md:w-8 md:h-8 text-primary-foreground mb-4 sm:mb-4 md:mb-4 mx-auto" />
                  <h3 className="text-lg sm:text-lg md:text-xl font-heading font-semibold text-primary-foreground mb-2">
                    For Businesses
                  </h3>
                  <p className="text-primary-foreground/80 mb-4 text-base sm:text-base md:text-base leading-relaxed">
                ...
                <div className="bg-background/10 backdrop-blur-sm rounded-lg p-5 sm:p-5 md:p-6 border border-primary-foreground/20">
                  <Shield className="w-8 h-8 sm:w-7 sm:h-7 md:w-8 md:h-8 text-primary-foreground mb-4 sm:mb-4 md:mb-4 mx-auto" />
                  <h3 className="text-lg sm:text-lg md:text-xl font-heading font-semibold text-primary-foreground mb-2">
                    For Professionals
                  </h3>
                  <p className="text-primary-foreground/80 mb-4 text-base sm:text-base md:text-base leading-relaxed">
